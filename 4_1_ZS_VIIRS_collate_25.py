...
basedir = "D:/Paper2/"
fulldir = basedir + 'Data/Fishnet_Arc_VIIRS_25/'
...
for i in spatscale:
    ...
    for j in years:
        j = j+1
        fname = cellsizestr + "degby" + cellsizestr + "deg" + "_" + str(j) + "_25.gpkg"
    ...
    gdf.to_file("D:/Paper2/Data/Fishnet_Arc_VIIRS_25/Compiled/"+cellsizestr + "degby" + cellsizestr + "deg"+"_25.gpkg")
