...
datatstest = preptestdata(2016,datab)
...
datatstest = preptestdata(2017,datab)
...
datatstest = preptestdata(2018,datab)
...
datatstest = preptestdata(2019,datab)
...
ggsave("D:/Paper2/Figures/rf_forecasting model_validation_between.pdf",figout)
...
Forecast_btwn("SSP1",datats,sspurban,sspgdppc,2030,datab)
Forecast_btwn("SSP2",datats,sspurban,sspgdppc,2030,datab)
Forecast_btwn("SSP3",datats,sspurban,sspgdppc,2030,datab)
Forecast_btwn("SSP4",datats,sspurban,sspgdppc,2030,datab)
Forecast_btwn("SSP5",datats,sspurban,sspgdppc,2030,datab)

Forecast_btwn("SSP1",datats,sspurban,sspgdppc,2040,datab)
Forecast_btwn("SSP2",datats,sspurban,sspgdppc,2040,datab)
Forecast_btwn("SSP3",datats,sspurban,sspgdppc,2040,datab)
Forecast_btwn("SSP4",datats,sspurban,sspgdppc,2040,datab)
Forecast_btwn("SSP5",datats,sspurban,sspgdppc,2040,datab)

Forecast_btwn("SSP1",datats,sspurban,sspgdppc,2050,datab)
Forecast_btwn("SSP2",datats,sspurban,sspgdppc,2050,datab)
Forecast_btwn("SSP3",datats,sspurban,sspgdppc,2050,datab)
Forecast_btwn("SSP4",datats,sspurban,sspgdppc,2050,datab)
Forecast_btwn("SSP5",datats,sspurban,sspgdppc,2050,datab)